...
void halftone() {
    ...
    vec4 center_color = video_color(st);
    vec4 left_color = video_color(st - offset.xz);
    vec4 right_color = video_color(st + offset.xz);
    vec4 top_color = video_color(st + offset.zy);
    vec4 bottom_color = video_color(st - offset.zy);
    vec4 tl_color = video_color(st + vec2(-offset.x, offset.y));
    vec4 tr_color = video_color(st + offset.xy);
    vec4 bl_color = video_color(st - offset.xy);
    vec4 br_color = video_color(st + vec2(offset.x, -offset.y));
